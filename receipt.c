...
char receipt(float change, float amount, struct Costumer costumer); //Function that prints the receipt
int payment(float *priceP, struct Costumer costumer); //Function that the program commands the buyer to pay the products he/she bought
void rebuy(int prod_choice, float *priceP, struct Costumer costumer); //Function where if the buyer wants to buy again
...
char receipt(float change,float amount,struct Costumer costumer) {
    float tax = 0.12,
...
int payment(float *priceP, struct Costumer costumer) {
...
void rebuy(int prod_choice, float *priceP, struct Costumer costumer) {
    int op;
    int quantity;
